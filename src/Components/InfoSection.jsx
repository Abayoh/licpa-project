...
function InfoSection() {
  return (
  <section className="pt-20 lg:pt-[120px] pb-8 lg:pb-[70px] lg:mx-10">
    <div className="container">
      <div className="flex flex-wrap">
        <div className="w-full px-4">
          <div className="mb-12 lg:mb-20 max-w-[620px]">
            <span className="font-semibold text-lg text-primary mb-2 block">Students Services / Member Services</span>
            <h2 className="font-bold text-3xl sm:text-4xl md:text-[42px] text-dark mb-4">LICPA Programs</h2>
      ...
      <div className="flex flex-wrap">
        <div className="w-full md:w-1/2 lg:w-1/4 px-4">
          <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".1s">
            <div className="w-[70px] h-[70px] flex items-center justify-center bg-dark rounded-2xl mb-8 relative z-10">
              <span className="w-[70px] h-[70px] flex items-center justify-center bg-dark bg-opacity-20 rounded-2xl mb-8 absolute z-[-1] top-0 left-0 rotate-[25deg] group-hover:rotate-45 duration-300"></span>
            ...
            <h4 className="font-bold text-xl text-dark mb-3">
                Syllabi Integration Program (SIP) 
            </h4>
            <p className="text-body-color mb-8 lg:mb-11">
                    How to Enroll into the Syllabi Integration Program (SIP) Application to the SIP is done through the regular admission process for the participating university. Generally, applicants to universities in Liberia have to pass an entrance and placement examination...
            </p>
            <a href="#about" className="font-medium text-base text-body-color hover:text-primary">
              Learn More
            </a>
          </div>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/4 px-4">
          <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".15s">
            ...
            <a href="#about" className="font-medium text-base text-body-color hover:text-dark">
              Learn More
            </a>
          </div>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/4 px-4">
          <div className="bg-white mb-12 group wow fadeInUp" data-wow-delay=".2s">
            ...
            <a href="#abou" className="font-medium text-base text-body-color hover:text-dark">
              Learn More
            </a>
          </div>
        </div>
