...
function ContactSection() {
  return (
    <section id="contact" className=" md:py-[120px] relative py-12 md:px-7 sm:px-12 md:p-16 lg:py-9 lg:px-16 xl:p-[70px]" >
            ...
            <div className="ud-contact-content-wrapper">
              ...
              <div className="flex flex-wrap justify-between mb-12 lg:mb-0">
                <div className="flex max-w-full w-[330px] mb-8">
                  <div className="text-[32px] text-dark mr-6">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color">
                      4th Floor Lara Building, Randall Street Monrovia, Liberia
                    </p>
                  </div>
                </div>
                <div className="flex max-w-full w-[330px] mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color">Email: licpa@licpa.org.lr</p>
                    <p className="text-base text-body-color">Phone: +231-88-694679 </p>
                  </div>
                </div>
              </div>
            </div>
