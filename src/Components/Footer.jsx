        ...
        <div className="flex flex-wrap lg:px-20">
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
            <div className="w-full mb-10">
              <a href="#home" className="inline-block max-w-[160px] mb-6" >
              ...
              <div className="flex items-center -mx-3">
                <a href="#logo" className="px-3 text-[#dddddd] hover:text-white">
                ...
                <a href="#nma" className="px-3 text-[#dddddd] hover:text-white">
                ...
                <a href="#fls" className="px-3 text-[#dddddd] hover:text-white">
                ...
                <a href="#lskd" className="px-3 text-[#dddddd] hover:text-white">
                  <svg width="18" height="18" viewBox="0 0 18 18" className="fill-current">
          ...
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12 px-4">
            <div className="w-full mb-10">
              ...
              <ul>
                <li>
                  <a href="#obje" className="inline-block  text-base text-[#f3f4fe]  hover:text-primary  leading-loose  mb-2">
                    Our Objective
                  </a>
                </li>

                <li>
                  <a href="#o" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Functions of LICPA
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#hist" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    History
                  </a>
                </li>
                <li>
                  <a href="#go" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " >
                    Govering Concil
                  </a>
                </li>
              </ul>
          ...
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
            <div className="w-full mb-10">
              ...
              <ul>
                <li>
                  <a href="#st" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Student Eligibility
                  </a>
                </li>
                <li>
                  <a href="#student" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Student Application
                  </a>
                </li>
                <li>
                  <a href="#fees" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 ">
                    Student Fees
                  </a>
                </li>
              </ul>
          ...
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
            <div className="w-full mb-10">
              ...
              <ul>
                <li>
                  <a href="#firm" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Firm Member
                  </a>
                </li>
                <li>
                  <a href="#men" className=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 ">
                    Licensend Member
                  </a>
                </li>
                <li>
                  <a href="#in" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Individual / Chartered Members
                  </a>
                </li>
                <li>
                  <a href="#st" className="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 ">
            ...
            <div className="w-full md:w-2/3 lg:w-1/2 px-4">
              <div className="my-1">
                <div className="flex items-center justify-center md:justify-start -mx-3">
                  <a href="#po" className="text-base text-[#f3f4fe] hover:text-primary px-3">
                    Privacy policy
                  </a>
                  <a href="#legal" className="text-base text-[#f3f4fe] hover:text-primary px-3">Legal notice</a>
                  <a href="#terms" className="text-base text-[#f3f4fe] hover:text-primary px-3">
                    Terms of service
                  </a>
                </div>
              </div>
            ...
            <div className="w-full md:w-1/3 lg:w-1/2 px-4">
              <div className="flex justify-center md:justify-end my-1">
                <p className="text-base text-[#f3f4fe]">
                  ...
                  <a href="#home" rel="nofollow noopner" target="_blank" className="text-primary hover:underline">
                    Jenkins Mulbah
                  </a>
                </p>
              </div>
